                ...
                $table .= '
                        ...
                        <div class="flex items-center justify-center">
                            <form class="AjaxForm" action="' . APPURL . 'app/ajax/patientsAjax.php" method="POST"> 
                                ...
                                <a href="'.APPURL.'editPatients/'.$rows['patient_ID'].'" class="text-white bg-yellow-500 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 transition duration-100">
