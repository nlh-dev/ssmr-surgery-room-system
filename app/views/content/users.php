<div class="p-4">
    <div class="p-4 mt-14">
        <?php require_once "./app/views/components/breadcrumbs/UsersBreadcrumb.php"; ?>
        <hr class="my-4 text-gray-300">

        <div class="w-full flex items-center justify-end my-2">
            <button data-modal-target="addUsersModal" data-modal-toggle="addUsersModal" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg text-center transition duration-100">
            ...
            <?php require_once "./app/views/components/modals/AddUsersModal.php"; ?>
        </div>
