<?php
    ...
    $patientStates = new patientsController();
    $showPatientStates = $patientStates -> getPatientStatesController();
?>

<div class="p-4">
    <div class="p-4 mt-14">
        <!-- BREADCRUM STARTS -->
        <?php require_once "./app/views/components/breadcrumbs/addPatientsBreadcrumb.php"; ?>
            ...
            <div class="grid mb-6 grid-cols-6 gap-5">
                ...
                <div>
                    ...
                    <div class="relative my-2">
                        ...
                        <input type="number" id="patientYearsOld" name="patientYearsOld" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Inserte edad....">
                    </div>
                </div>
